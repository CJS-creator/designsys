...
export function HeroSection({ designSystem }: { designSystem: GeneratedDesignSystem }) {
    return (
        <div className="relative p-8 md:p-12 rounded-[2.5rem] bg-gradient-to-br from-primary/10 via-background to-background border border-primary/10 overflow-hidden group">
            <div className="absolute inset-0 bg-grid-black/[0.02] dark:bg-grid-white/[0.02]" />
            <div className="relative z-10 max-w-2xl">
                <Badge variant="outline" className="mb-6 bg-primary/5 text-primary border-primary/20 backdrop-blur-sm px-4 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase">

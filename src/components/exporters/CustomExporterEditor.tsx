...
import { Code2, Play, Save, Trash2, HelpCircle, FileJson, FileCode, Check, Copy } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="pt-4 border-t space-y-2">
                        ...
                        {templates.map(t => (
                            <div key={t.id} className="flex items-center justify-between p-2 rounded border bg-muted/20 text-xs">
                                ...
                                <Button variant="ghost" size="icon" className="h-6 w-6 text-red-500" onClick={() => handleDelete(t.id)}>
            ...
            <Card className="flex flex-col">
                ...
                <CardContent className="flex-1 flex flex-col min-h-[400px]">
                    <ScrollArea className="flex-1 rounded-xl border bg-black/90 p-4 font-mono text-[10px] text-green-400">
